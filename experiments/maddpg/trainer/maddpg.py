...
def p_train(make_obs_ph_n, act_space_n, p_index, p_func, q_func, optimizer, grad_norm_clipping=None,
    ...
    with tf.variable_scope(scope, reuse=reuse):
        ...
        act_mode = U.function(inputs=[obs_ph_n[p_index]], outputs=act_mode)
        ...
        return act_mode, act, train, update_target_p, {'p_values': p_values, 'target_act': target_act}
...
class MADDPGAgentTrainer(AgentTrainer):
    def __init__(self, name, model, obs_shape_n, act_space_n, agent_index, args, local_q_func=False):
        ...
        self.act_mode, self.act, self.p_train, self.p_update, self.p_debug = p_train(
            scope=self.name,
            make_obs_ph_n=obs_ph_n,
            act_space_n=act_space_n,
            p_index=agent_index,
    ...
    def update(self, agents, t):
        ...
        for i in range(num_sample):
            ...
            # print('rew',rew)
            # print('done',done)
            # print('target_q_next',target_q_next)
